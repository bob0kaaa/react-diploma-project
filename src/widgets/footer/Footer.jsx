                    ...
                    <section>
                        ...
                        <ul className="nav flex-column">
                            <li className="nav-item">
                                <Link to={ROUTES.ABOUT} className="nav-link">О магазине</Link>
                            </li>
                            <li className="nav-item">
                                <Link to={ROUTES.CATALOG} className="nav-link">Каталог</Link>
                            </li>
                            <li className="nav-item">
                                <Link to={ROUTES.CONTACTS} className="nav-link">Контакты</Link>
                            </li>
                        </ul>
                    </section>
                </div>
